...
const UpdateUserForm = ({dispatch, loading, hasErrors}) => {
  ...
  return (
        <Form className='m-5'>
            ...
            <Button variant="primary" type="button"
                    onClick={e => 
                        dispatch(updateUser(process.env["REACT_APP_SESSION_URL"], {username, givenName, familyName, email, phone, password}))}
                        as={Link} to='/myaccount'>
                            Update
                        </Button>
        </Form>
  );
